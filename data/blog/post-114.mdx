...
但实际排查下来，其实不是 Codex 主程序慢，也不是模型慢，而是它启动时顺手拉起了太多周边服务。
...
---
此文自动发布于：<a href="https://github.com/coderPerseus/blog/issues/114" target="_blank">github issues</a>
